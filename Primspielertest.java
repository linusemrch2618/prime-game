...
public class Primspielertest implements Logging {
    ...
    private void loadPlayerClasses() {
        try {
            playerA = (PolytechnicCompetitionPlayer) Class.forName(home).newInstance();
            playerB = (PolytechnicCompetitionPlayer) Class.forName(guest).newInstance();
    ...
    protected void dumpEvent(PropertyChangeEvent evt) {
        ...
        if (PrimeGame.EVENT_BOARD.equals(e)) {
            ...
            // THM for Special Rules Christmas Edition 2021
